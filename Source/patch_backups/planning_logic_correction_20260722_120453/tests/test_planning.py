...
def test_item_planning_separates_sales_demand_cover_alignment_and_stale_commitments() -> None:
    with Session(_engine()) as session:
        ...
        assert analysis.cover_committed_delta == Decimal("-20")
        ...
        assert analysis.commitments.other_current_committed == Decimal("0")
        ...
        assert any("Cover alignment warning" in reason for reason in analysis.reasons)
